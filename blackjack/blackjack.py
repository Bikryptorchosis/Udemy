...
def load_images(card_images):
    ...
    # retrieve the image for each suit card
    for suit in suits:
        # 1 to 10
...
def deal_dealer():
    ...
    if player_score > 21:
        ...
        result_text.set("A winner is yuo!")
    elif dealer_score > player_score:
        result_text.set('Dealer wins you fuckoooo')
    else:
        result_text.set("DRAWWWWWWWW")
...
# set up the screen and frames for everyone
...
reset_button.grid(row=1, column=0, columnspan=2, sticky='ew')
